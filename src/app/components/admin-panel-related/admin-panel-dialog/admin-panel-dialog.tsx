...
function AdminPanelDialog( props:{ children: ReactNode} , ref: React.Ref<AdminPanelDialogHandle> ) {
    ...
    return <dialog ref={dialog}>
        <button className="close-dialog-button" onClick={() => dialog.current.close()}><Image src={CloseDialogIcon} alt="close dialog icon" /></button>
        {props.children}
    </dialog>
