    ...
    return (
        <GeneralLayout>
            ...
            <section className="appointment-form">
                ...
                <form action="/submit-appointment" method="post" className="form-container">
                    ...
                    <div className="form-group">
                        ...
                        <textarea id="notes" name="notes" placeholder="Czy masz jakieś szczególne wymagania?"></textarea>
                    </div>
